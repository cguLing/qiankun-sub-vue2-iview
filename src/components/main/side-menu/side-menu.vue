<template>
  <div class="side-menu-wrapper" style="background: #E4EAEF;">
    <slot></slot>
    <Menu ref="menu" v-show="!collapsed" class="aaa" :active-name="activeName" :open-names="openedNames" :accordion="accordion" :theme="theme" width="auto" @on-select="handleSelect" >
      <template v-for="item in menuList">
        <template v-if="item.children && item.children.length === 1"  style="margin-right: 0px;">
